...
class Histograma():
    ...
    def determinarIntervalo(self , numintervalo, datos, tamanoMuestra):
        '''Crea una lista de tuplas con los valores necesarios para los intervalos de frecuencias.
        
        las tuplas tienen el sig formato:
        (lim inferior, lim superior, marca de clase, frecuencia de intervalo, prob observada, frecuencia acumulada, frec relativa acumulada)'''
